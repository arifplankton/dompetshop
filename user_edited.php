...
$qry=mysql_query("UPDATE costumer SET customer_id='$customer_id',customer_nm='$customer_nm',customer_uname='$customer_uname',
	customer_pwd='$customer_pwd',customer_almt='$customer_almt',customer_prov='$customer_prov',customer_kdpos='$customer_kdpos',customer_telp='$customer_telp' 
