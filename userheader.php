    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Dompet Online</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <div id="topnav">
                      <ul>
                        ...
                        <li> <a href="hore.php"> <?php echo $_SESSION['nm_costumer']?></a>
                           
                            <li><?php  
                                if (isset($_SESSION['customer'])) $status = "<a href=logout.php>logout</a>"; 
