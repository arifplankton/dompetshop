...
<dl>
<dt><label for="title">Kode Konfirmasi</label></dt>
...
<dd><input type="date" name="tgl_kirim"  required class="" placeholder="YYYY-MM-DD"  size="35" /></dd>
</dl>

<dl>
<dt><label for="title">Alamat</label></dt>
<dd><input type="text" name="alamat" id="alamat" value="" size="35"/></dd>
</dl>

<dl>
<dt><label for="title">Kode Provinsi</label></dt> 
<dd><input type="text" name="kd_provinsi" id="kd_provinsi" size="35"/></dd>
</dl>

<dl>
<dt><label for="title">Kode Pos</label></dt> 
<dd><input type="text" name="kd_pos" id="kd_pos" size="35"/></dd>
</dl>

<dl>
<dt><label for="title">No Telpon</label></dt> 
<dd><input type="text" name="no_tlp" id="no_tlp" size="35"/></dd>
</dl>
